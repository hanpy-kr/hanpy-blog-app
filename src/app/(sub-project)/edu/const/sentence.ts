...
export const businessPatterns: ItemType[] = [
  ...
  },
  {
    ...
    en: 'Could I interrupt you to ask for your opinion on this matter?',
    ko: '이 무제에 대한 당신의 의견을 묻기 위해 당신을 방해해도 될까요??',
  },
  {
  ...
  {
    id: 'BUSINESS_SENTENCE_22',
    en: "In summary, we've covered the main points of the project and its timeline.",
    ko: '요약하면 프로젝트의 주요 사항과 일정에 대해 다루었습니다.',
  },
  {
    id: 'BUSINESS_SENTENCE_23',
    en: "I appreciate everyone's attendance at this online meeting.",
    ko: '이 온라인 회의에 참석해 주신 모든 분들께 감사드립니다.',
  },
  {
    id: 'BUSINESS_SENTENCE_24',
    en: 'I encourage everyone to speak up and share their thoughts on this matter.',
    ko: '저는 모든 사람이 이 문제에 대해 목소리를 높이고 생각을 공유할 것을 권장합니다.',
  },
  {
    id: 'BUSINESS_SENTENCE_25',
    en: "I still don't understand the purpose of this metting, could you clarify it for me?",
    ko: '아직 이 회의의 목적을 이해하지 못하겠습니다. 명확하게 말씀해 주시겠습니까?',
  },
]
