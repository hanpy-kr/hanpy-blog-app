...
deployment: true
category: Backend
title: 'child_process.fork (Node.js 멀티프로세싱)'
...
# child_process.fork (Node.js 멀티프로세싱)
...
- <codeline>fork</codeline>는 <codeline>child_process.spawn</codeline>의 특수한 형태로, Node.js 모듈을 자식 프로세스로 실행할 때 사용됩니다.
...
- <codeline>exec</codeline>, <codeline>spawn</codeline>과 달리 Node.js 전용 코드 실행에 최적화되어 있습니다.
...
<codeline>child_process.fork</codeline>는 Node.js 애플리케이션에서 CPU 집중 작업을 효과적으로 분리할 수 있는 강력한 도구입니다. 특히 실시간 처리, 병렬 연산, 워커 기반 구조를 설계할 때 꼭 알아두어야 할 API입니다.
