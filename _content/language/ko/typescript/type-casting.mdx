...
category: Language
title: 'Type Casting'
summary: '타입스크립트에서 타입 단언(as 등)과 JSX 환경에서의 주의점을 정리합니다.'
pageKey: typescript_type_casting
lng: KOR
publishedAt: 2025-06-01
tags: [TypeScript, 타입 단언]
---
...
✅ as 키워드를 사용하여 캐스팅하는 방식이 가장 일반적 (예: `as InternalAxiosRequestConfig & { _retry?: boolean }`)
