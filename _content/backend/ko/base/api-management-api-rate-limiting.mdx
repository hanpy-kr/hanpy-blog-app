...
<codeline>Rate Limiting</codeline>은 **일정 시간 동안 클라이언트가 API를 호출할 수 있는 횟수를 제한**하는 기술입니다. 예를 들어, "1분에 최대 100번의 요청 허용"과 같은 방식입니다. 이를 통해 과도한 요청으로부터 시스템 자원을 보호하고 서비스 안정성을 유지할 수 있습니다.
